      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="text-center">
            <p className="font-bold text-2xl text-gray-800">Quốc Đạt</p>
            <p className="text-gray-500">Vận Tải Dũng Ánh</p>
          </div>
          <div className="p-2 border-4 border-blue-500 rounded-lg">
            <img
              src="https://horizons-cdn.hostinger.com/7ce12260-0bb2-4743-b9a1-97e8fa680e0b/3d74fbda08d04002dfda5800fc4787b2.png"
              alt="Zalo QR Code for Quoc Dat"
              className="w-64 h-64"
            />
          </div>
